...
const One = () => {
    return (
        <div className="col-span-2 row-span-4 style-block flex flex-col justify-between animate-fade-in-down">
            <div className="max-w-[85%] font-md flex flex-col gap-2 text-lg">
                <div>
                    <span className="ml-3 text-sm text-text-sec">
                        welcome
                    </span>
                    <p>
                        I'm <span className="font-bold">Miguel</span>
                         — a Brazilian full-stack developer with a
                        passion for turning ideas into clean,
                        functional, and beautiful digital experiences.
                    </p>
                </div>
                <p>
                    Whether you have a project in mind or just want to
                    connect, feel free to reach out. Let's build
